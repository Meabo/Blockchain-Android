...
public class Wallet {
    ...
    @Expose
    private Integer nTx;
    @SerializedName("n_tx_filtered")
    @Expose
    private Integer nTxFiltered;
    ...
    public Integer getNTxFiltered() {
        return nTxFiltered;
    }

    public void setNTxFiltered(Integer nTxFiltered) {
        this.nTxFiltered = nTxFiltered;
    }
